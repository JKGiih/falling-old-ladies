...
function enemies.draw()
   ...
   for i = 1, table.getn(ladies) do
      ...
      elseif ladies[i][2] < screenHeight - 8 then
         love.graphics.draw(ladiesCanvases[9], (widescreenOffset + ladies[i][1]- 5) * canvasScale, lockToGrid(ladies[i][2]) * canvasScale, 0, 1, 1)
      elseif ladies[i][2] < screenHeight - 7 then
         love.graphics.draw(ladiesCanvases[10], (widescreenOffset + ladies[i][1]- 5) * canvasScale, lockToGrid(ladies[i][2]) * canvasScale, 0, 1, 1)
      elseif ladies[i][2] < screenHeight - 6 then
         love.graphics.draw(ladiesCanvases[11], (widescreenOffset + ladies[i][1]- 5) * canvasScale, lockToGrid(ladies[i][2]) * canvasScale, 0, 1, 1)
      elseif ladies[i][2] < screenHeight - 5 then
         love.graphics.draw(ladiesCanvases[12], (widescreenOffset + ladies[i][1]- 5) * canvasScale, lockToGrid(ladies[i][2]) * canvasScale, 0, 1, 1)
      elseif ladies[i][2] < screenHeight - 4 then
         love.graphics.draw(ladiesCanvases[13], (widescreenOffset + ladies[i][1]- 5) * canvasScale, lockToGrid(ladies[i][2]) * canvasScale, 0, 1, 1)
      else   
