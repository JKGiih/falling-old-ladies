function love.conf(t)
    t.identity = "FoL"                   -- The name of the save directory (string)
    t.version = "0.9.2"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)
    t.window.title = "Falling Old Ladies"        -- The window title (string)
    t.window.icon = "assets/falling.png"                -- Filepath to an image to use as the window's icon (string)
    t.window.width = 1024 -- 1024               -- The window width (number)
    t.window.height = 768 -- 768              -- The window height (number)
